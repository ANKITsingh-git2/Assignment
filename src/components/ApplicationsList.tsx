        ...
        .select(`
          *,
          jobs!inner(
            ...
            daily_wage,
            duration_days,
            profiles!jobs_manufacturer_id_fkey(name),
            ...
            <CardHeader>
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <CardDescription>
                    {application.jobs.manufacturer_details[0]?.factory_name} • Applied on {new Date(application.created_at).toLocaleDateString()}
                  </CardDescription>
                </div>
                <Badge variant={
